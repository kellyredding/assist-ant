...
final class WebViewFindController: NSObject, ObservableObject {
    ...
    private static func jsEscape(_ s: String) -> String {
        s.replacingOccurrences(of: "\\", with: "\\\\")
            ...
            // U+2028 and U+2029 are line terminators to a JS parser, so an
            // unescaped one breaks the literal exactly as a raw newline
            // would. Reachable by pasting text from a web page.
